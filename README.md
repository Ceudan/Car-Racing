...
A second hurdle we faced was overcoming turn failures caused by excessive speed. Our thrust agent often produced high speed high score episodes (930 reward), but every 10 episodes or so it would spin out and fail. This dragged down our testing average to roughly 870. We overcame this hurdle by over/under emphasizing training data. We simply skipped training on a fraction of high speed episodes to reduce the urge to learn dangerous speeds. Finally we handpicked our final test model after a modal collapse caused by excessive breaking, knowing that this model was likely the safest. 
